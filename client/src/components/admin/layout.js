...
import Support from './supports/index'
...
const routes = [
  ...
  { path: '/supports', component: Support, title: 'Customers support' }
]
  ...
  <div>
    <div className="ui fixed main borderless menu">
      <a href="#" className="header item">
        <img className="logo" style={{marginRight: "1.5em"}} alt=""
          src="https://cdn3.iconfinder.com/data/icons/shopping-solid-icons-vol-2/64/064-512.png"/>
        Tung shop Admin
      </a>
